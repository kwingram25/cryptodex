...
export default {
  ...
  komodo: address => `https://kmd.explorer.supernet.org/address/${address}`,
  ...
  nem: address => `http://explorer.nemchina.com/#/s_account?account=${address}`,
  ...
  reddcoin: address => `https://live.reddcoin.com/address/${address}`,
